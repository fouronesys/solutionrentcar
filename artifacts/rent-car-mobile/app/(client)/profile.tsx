...
export default function ProfileScreen() {
  ...
  const confirmDeleteAccount = () => {
    Alert.alert(t("profile.deleteAccountConfirmTitle"), t("profile.deleteAccountConfirmMsg"), [
      { text: t("common.cancel"), style: "cancel" },
      { text: t("profile.deleteAccount"), style: "destructive", onPress: deleteAccount },
    ]);
  };
        ...
        <ScrollView contentContainerStyle={{ padding: 16 }} keyboardShouldPersistTaps="handled">
          ...
          <Card>
            ...
            <View style={{ flexDirection: "row" }}>
              <Button title="Español" variant={lang === "es" ? "primary" : "secondary"} onPress={() => { setLocale("es"); setLang("es"); }} style={{ flex: 1, marginRight: 6 }} />
              <Button title="English" variant={lang === "en" ? "primary" : "secondary"} onPress={() => { setLocale("en"); setLang("en"); }} style={{ flex: 1, marginLeft: 6 }} />
            </View>
          </Card>
          ...
          {role === "client" ? (
            <View style={styles.deleteSection}>
              <Pressable style={[styles.deleteBtn, deletingAccount && styles.deleteBtnDisabled]} onPress={confirmDeleteAccount} disabled={deletingAccount}>
                {deletingAccount ? (
...
const styles = StyleSheet.create({
  ...
  docRow: { paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: colors.border },
  ...
  docBtn: { backgroundColor: colors.primary, paddingHorizontal: 14, paddingVertical: 8, borderRadius: 6, marginLeft: 6, minWidth: 90, alignItems: "center" },
  docBtnText: { color: "#1A1A1A", fontWeight: "600", fontSize: 13 },
  docBtnSec: { backgroundColor: "transparent", paddingHorizontal: 12, paddingVertical: 8, borderRadius: 6, borderWidth: 1, borderColor: colors.border },
  docBtnSecText: { color: colors.text, fontWeight: "600", fontSize: 13 },
  deleteSection: { marginTop: 24, marginBottom: 16, alignItems: "center" },
  deleteBtn: { paddingVertical: 10, paddingHorizontal: 20, borderRadius: 8, borderWidth: 1, borderColor: "#dc2626", minWidth: 180, alignItems: "center" },
