  ...
  return (
    <>
      ...
      >
        <Tabs.Screen
          name="agenda"
          options={{ title: t("tabs.agenda"), tabBarIcon: ({ focused }) => <TabIcon label="🗓️" focused={focused} /> }}
        />
        <Tabs.Screen
          name="bookings"
          options={{ title: t("tabs.bookings"), tabBarIcon: ({ focused }) => <TabIcon label="📋" focused={focused} /> }}
        />
        <Tabs.Screen
          name="notifications"
          options={{ title: t("tabs.notifications"), tabBarIcon: ({ focused }) => <InboxIcon focused={focused} /> }}
        />
        <Tabs.Screen
          name="profile"
          options={{ title: t("tabs.profile"), tabBarIcon: ({ focused }) => <TabIcon label="👤" focused={focused} /> }}
        />
