...
$products = PersonData::getRClientsWithCredit();


// Add some data
$sheet = $objPHPExcel->setActiveSheetIndex(0);

$sheet->setCellValue('A1', 'Proveedor con Creditos')
->setCellValue('A2', 'Id')
...
header('Content-Disposition: attachment;filename="credit_provider-'.time().'.xlsx"');
