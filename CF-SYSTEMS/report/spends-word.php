...
$sells = SpendData::getAllUnBoxed();

$section1 = $word->AddSection();
$section1->addText("GASTOS",array("size"=>22,"bold"=>true,"align"=>"right"));
...
//$q=OperationData::getQByStock($sell->id,$stock);
    ...
    $table1->addRow();
     if($sell->kind==1){
    $table1->addCell(300)->addText("Gastos");
} else if($sell->kind==2){
    $table1->addCell(300)->addText("Devolucion");
} 
