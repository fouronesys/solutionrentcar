...
$clients = PersonData::getRClientsWithCredit();


$section1 = $word->AddSection();
$section1->addText("PROVEEDORES CON CREDITO",array("size"=>22,"bold"=>true,"align"=>"right"));
...
$sells = SellData::getRCreditsByClientId($client->id);
...
$filename = "credit_provider-".time().".docx";
