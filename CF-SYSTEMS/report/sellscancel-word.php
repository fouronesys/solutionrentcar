...
$sells = SellData::getAllBySQL(" where operation_type_id=2 and p_id=3 and d_id=3");

$section1 = $word->AddSection();
$section1->addText("VENTAS CANCELADAS",array("size"=>22,"bold"=>true,"align"=>"right"));
...
$filename = "sellscancel-".time().".docx";
