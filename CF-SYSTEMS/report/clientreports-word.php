...
$section1->addText("CLIENTES POPULARES",array("size"=>22,"bold"=>true,"align"=>"right"));
...
$table1->addRow();
$table1->addCell()->addText("Id Cliente");
...
$table1->addRow();
$table1->addCell(5000)->addText($operation->person_id);
$table1->addCell(5000)->addText($symbol." ".number_format($operation->st,2,".",","));
$table1->addCell(5000)->addText($operation->getPerson()->name." ".$operation->getPerson()->lastname." ".$ops);
}

$word->addTableStyle('table1', $styleTable,$styleFirstRow);
/// datos bancarios

$filename = "topclients-".time().".docx";
