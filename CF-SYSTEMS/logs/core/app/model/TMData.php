...
// partiendo de que ya tenemos creado un objecto TMData previamente utilizamos el contexto
	...
	public static function getById($id){
		...
		return Model::one($query[0],new TMData());
	}
	...
	public static function getAllBySQL($sqlextra){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new TMData());
	}
