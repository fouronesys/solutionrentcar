<?php
class CNDData {
	public static $tablename = "cndebito";
	...
	public static function getById($id){
		...
		return Model::one($query[0],new CNDData());
	}
	...
	public static function getAllProductsBySellId($sell_id){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new CNDData());
	}
	...
	public function update(){
		$sql = "update ".self::$tablename." set sell_id=\"$this->sell_id\", status=\"$this->status\" where id=\"$this->cnd_id\"";
		Executor::doit($sql);
	}
