<?php
class CGTData {
	public static $tablename = "cgastos";
	...
	public static function getById($id){
		...
		return Model::one($query[0],new CGTData());
	}
	...
	public static function getAllProductsBySellId($sell_id){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new CGTData());
	}
	...
	public function update(){
		$sql = "update ".self::$tablename." set sell_id=\"$this->sell_id\", status=\"$this->status\" where id=\"$this->cgt_id\"";
		Executor::doit($sql);
	}
