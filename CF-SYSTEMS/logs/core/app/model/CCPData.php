<?php
class CCPData {
	public static $tablename = "ccompras";
	...
	public static function getById($id){
		...
		return Model::one($query[0],new CCPData());
	}
	...
	public static function getAll(){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new CCPData());
	}
	...
	public function update(){
		$sql = "update ".self::$tablename." set sell_id=\"$this->sell_id\", status=\"$this->status\" where id=\"$this->ccp_id\"";
		Executor::doit($sql);
	}
