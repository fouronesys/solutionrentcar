<?php
class CFSData {
	public static $tablename = "cfiscal";
	...
	public static function getById($id){
		...
		return Model::one($query[0],new CFSData());
	}
	...
	public static function getAllProductsBySellId($sell_id){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new CFSData());
	}


	public static function getAllBySellId($sell_id){
		$sql = "select * from ".self::$tablename." where sell_id=$sell_id and c_id=1";
		$query = Executor::doit($sql);
		return Model::many($query[0],new CFsData());
	}
	...
	public function update(){
		$sql = "update ".self::$tablename." set sell_id=\"$this->sell_id\", status=\"$this->status\" where id=\"$this->cfs_id\"";
		Executor::doit($sql);
	}
