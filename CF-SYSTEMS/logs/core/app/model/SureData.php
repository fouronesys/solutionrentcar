<?php
class SureData {
	public static $tablename = "sure";


	public function add(){
		$sql = "insert into sure (name) ";
		$sql .= "value (\"$this->name\")";
		Executor::doit($sql);
	}
...
// partiendo de que ya tenemos creado un objecto SureData previamente utilizamos el contexto
	...
	public static function getById($id){
		...
		return Model::one($query[0],new SureData());
	}
	...
	public static function getAllBySQL($sqlextra){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new SureData());
	}
