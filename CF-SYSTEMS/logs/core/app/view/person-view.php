          ...
          <tr>
                  <td class="text-right py-0 align-middle">
                      <div class="btn-group btn-group-sm btn-block">
                        ...
                        <?php if($r['phone']>0):?>
                        <a href="https://clients.assanpos.com/?username=<?php echo $r['phone'];?>" target="_blank" class="btn btn-secondary"><i class="fas fa-eye"></i></a>
                        <?php else:?>
                        <a href="https://clients.assanpos.com/?username=<?php echo $r['phone2'];?>" target="_blank" class="btn btn-secondary"><i class="fas fa-eye"></i></a>
                        <?php endif;?>
                      </div>
        </td>
...
document.getElementById("form-cliente").addEventListener("submit", function(e) {
  ...
  if (navigator.onLine) {
    ...
    fetch("./?action=person&opt=add", {
      method: "POST",
      body: formData // ¡Esto permite enviar los archivos!
    })
    .then(res => res.text())
    .then(resp => {
      if (resp.trim() === "OK") {
...
?></label>
<?php if($user->license_date!=""):?>
<a href="CF-SYSTEMS/storage/invoice_files/<?php echo $user->license_date;?>"  class="btn btn-default"><i class="fa fa-file"></i> Archivo Cliente (<?php echo $user->license_date; ?>)</a>
...
if ($x['permits_id']==4): ?>
                       ...
                       <a href="./?action=person&opt=delproviders&id=<?php echo $r['sup_id'];?>" class="btn btn-danger btn-block btn-sm" onclick="return confirmDelete();" ><i class="fas fa-trash"> Eliminar</i></a>
