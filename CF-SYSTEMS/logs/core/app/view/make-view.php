...
$client = PersonData::getById($_GET["person_id"]);
                    ...
                    <?php foreach ($credit_array as $ca): ?>
                        <div class="card" style="background-color:#222;">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" method="post" enctype="multipart/form-data" id="addpayment<?php echo $ca['sell_id']; ?>" action="./?action=add&opt=payment" role="form">
