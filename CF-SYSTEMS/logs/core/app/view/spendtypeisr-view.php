...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
           <a href="./?view=spendtypeisr&opt=new" style="color: white;"> <h1 class="m-0"><i class='fa fa-th-list'></i> Tipos de ISR</a></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><i class='far fa-circle'></i> Tipos de Retencion ISR</a></li>
...
<table class="table table-bordered" id="example1">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
 <p style="color: white;">¿Que desea hacer a este tipo de ISR?</p>
<h4>Nombre: <?php echo utf8_decode($user->name); ?></h4>
<div class="row">
               <div class="col-md-6 col-6">
                  <a  href="./?view=spendtypeisr&opt=edit&id=<?php echo $user->id;?>" class="btn btn-success btn-block btn-sm"><i class='fa fa-edit'></i> Actualizar</a>
                </div>
                <div class="col-md-6 col-6">
                  <a href="./?action=spendtypeisr&opt=del&id=<?php echo $user->id;?>" class="btn btn-warning btn-block btn-sm"><i class='fa fa-trash'></i> Eliminar</a>
                </div>
</div>             
...
?>
    ...
    <h2>No hay Tipo de Retencion</h2>
...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
           <h1 class="m-0"><i class='fa fa-th-list'></i> Nuevo tipo de ISR</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><i class='fa fa-home'></i> Inicio</li>
       ...
       <div class="card">
<div class="card-body">
    <form class="form-horizontal" method="post" id="addspendsr" role="form">
...
<div class="row my-2" >
                <div class="col-md-6 col-6">
                  <a href="./?view=spendtypeisr&opt=all" class="btn btn-warning btn-block btn-sm"><i class='fa fa-times'></i> Cancelar</a>
                </div>
                <div class="col-md-6 col-6">
...
<script>
            ...
            jQuery("#addspendsr").submit(function(e){
                e.preventDefault();
                var formData = jQuery(this).serialize();
                $.ajax({
                  type: "POST",
                  url: "./?action=spendtypeisr&opt=add",
                  data: formData,
                  success: function(html){
                  if(html=='true')
                  {
                  $.jGrowl("Tipo de ISR Exito!", { sticky: true });
                  $.jGrowl("Se Agrego a la Base Datos", { header: 'Acceso permitido' });
                  var delay = 1000;
                    setTimeout(function(){ window.location = './?view=spendtypeisr&opt=all'  }, delay); 
...
<section class="content">
<?php $user = SGData::getById($_GET["id"]);?>
<div class="row">
  <div class="col-md-12">
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
           <h1 class="m-0"><i class='fa fa-edit'></i> Editar tipo de ISR</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><i class='fa fa-home'></i> Inicio</li>
       ...
       <div class="card">
<div class="card-body">
    <form class="form-horizontal" method="post" id="updspendsr"  role="form">
...
<script>
            jQuery(document).ready(function(){
            jQuery("#updspendsr").submit(function(e){
                e.preventDefault();
                var formData = jQuery(this).serialize();
                $.ajax({
                  type: "POST",
                  url: "./?action=spendtypeisr&opt=upd",
                  data: formData,
                  success: function(html){
                  if(html=='true')
                  {
