...
<?php $users = BookingData::getAllBySQL("where status=0 and stock_id=".StockData::getPrincipal()->id." order by id desc");
...
?>
 ...
 <a  href="./?action=booking&opt=what&id=<?php echo $user->id; ?>&person_id=<?php echo $user->person_id; ?>&car_id=<?php echo $user->car_id; ?>"  class="btn btn-success"><i class='fab fa-whatsapp'></i></a>

   <a href="#" onclick="abrirEImprimir('<?php echo $TicketMm;?>/ticket-reserve.php?id=<?php echo $user->id;?>')"  class="btn btn-info"><i class="fas fa-print"></i></a>
   
   <script>
function abrirEImprimir(url) {
  var ventana = window.open(url);
  ventana.focus();

  // Esperamos que cargue completamente antes de imprimir
...
<?php $users = BookingData::getAllBySQL("where status=0 and firma='' and stock_id=".StockData::getPrincipal()->id." order by id desc");
$TicketMm = StockData::getPrincipal()->ticket_mm;
$method = StockData::getPrincipal()->method;
    if(count($users)>0):?>
<div class="card" style="background-color:#222;">
...
<?php elseif(isset($_GET["opt"]) && $_GET["opt"]=="earring"):?>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
           <h1 class="m-0"><i class='fa fa-history'></i> <?php 
switch (Core::$user->language){
 case 'ES': echo "Reservas Pendientes"; break;
 case 'EN': echo "Pending Reservations"; break;
}
?></h1>
          </div><!-- /.col -->
        <div class="col-sm-6">
...
<div class="row">
  ...
  <span class="message-text">RESERVAS GRUPALES</span>
          ...
          <div class="col-12 col-sm-4 col-md-4 my-2">
             <a href="./?view=booking&opt=confirmation" class="floating-btn message-btn" style="background-color: #C70039;">
      <div class="icon-container">
    <i class="fa fa-edit"> </i>
...
<?php $users = WaitData::getAllBySQL("where stock_id=".StockData::getPrincipal()->id);
$TicketMm = StockData::getPrincipal()->ticket_mm;
$method = StockData::getPrincipal()->method;
    if(count($users)>0):?>
<div class="card" style="background-color:#222;">
...
switch (Core::$user->language){
 ...
 case 'EN': echo "Start"; break;
}
?></th>
      <th><?php 
switch (Core::$user->language){
 case 'ES': echo "Final"; break;
 case 'EN': echo "End"; break;
}
?></th>
    <th>Rentcar</th>
      <th><?php 
...
?></th>
 ...
 <a href="./?view=booking&opt=newearring&id=<?php echo $user->id;?>" class="btn btn-success"><i class="fas fa-check"></i></a>
                   </div>
        </td>

    
       <td><?php $brand = BrandData::getById($user->getCars()->brand_id); echo $brand->name." ".$user->getCars()->name." ".$user->getCars()->year." [".$user->getCars()->token."]"; ?></td>
        <td><?php echo $user->getPerson()->name; ?></td>
        <td><?php echo number_format($user->price,2,".",","); ?></td>
        <td><?php echo $user->day; ?></td>
        <td><?php echo number_format($user->total,2,".",","); ?></td>
        ...
        <td><?php echo $user->getStock()->name; ?></td>
        <td class="text-right py-0 align-middle">
         <a  href="./?action=delete&opt=wait&id=<?php echo $user->id;?>" class="btn btn-danger btn-block btn-sm"><?php 
switch (Core::$user->language){
...
<?php elseif(isset($_GET["opt"]) && $_GET["opt"]=="newearring"): $user = WaitData::getById($_GET["id"]);?>
<section class="content">
<div class="row">
  <div class="col-md-12">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
           <h1 class="m-0"><i class='fa fa-history'></i> <?php 
switch (Core::$user->language){
 case 'ES': echo "Procesar Reserva"; break;
 case 'EN': echo "Process Reservation"; break;
}
?></h1>
          </div><!-- /.col -->
        <div class="col-sm-6">
...
<i class="fa fa-clone"></i>  <?php 
switch (Core::$user->language){
 case 'ES': echo "Datos Extras"; break;
 case 'EN': echo "Extra Data"; break;
}
?>:
</div>
 <div class="col-md-4 col-12">
       <div class="input-group">
    <label for="inputEmail1" class="col-md-12 col-12 control-label">CARSEAT - [UND|PRECIO]</label>
     <span class="input-group-text autocomplete" style="background-color:orange;"><i class="fa fa-baby"></i></span>
     <input style="background-color: #333;" id="carseat1"  type="number" value="0" class="form-control" autocomplete="off"  name="unit_carseat"  placeholder="Unidad"  min="0">
       <input style="background-color: #333;" type="number" class="form-control" required value="0"  autocomplete="off" id="carseat2"  name="price_carseat" placeholder="Precio"  min="0" step="0.01">
    </div>
  </div>
 ...
 <div class="col-md-4 col-12">
       <div class="input-group">
    <label for="inputEmail1" class="col-md-12 col-12 control-label">INTERNET - [UND|PRECIO]</label>
     <span class="input-group-text autocomplete" style="background-color:orange;"><i class="fa fa-wifi"></i></span>
       <input style="background-color: #333;"  type="number" class="form-control" value="0" autocomplete="off" id="wifi1"  name="unit_wifi" placeholder="Unidad"  min="0" >
       <input style="background-color: #333;"  type="number" class="form-control" required value="0" autocomplete="off"  id="wifi2" name="price_wifi" placeholder="Precio"  min="0" step="0.01">
    </div>
  </div>
 ...
 <div class="col-md-4 col-12">
       <div class="input-group">
    <label for="inputEmail1" class="col-md-12 col-12 control-label">TRAILER - [UND|PRECIO]</label>
     <span class="input-group-text autocomplete" style="background-color:orange;"><i class="fa fa-sitemap"></i></span>
      <input style="background-color: #333;" type="number" value="0" class="form-control" autocomplete="off" id="trailer1"  name="unit_trailer" placeholder="Unidad"  min="0" >
       <input style="background-color: #333;"  type="number" class="form-control" value="0"  autocomplete="off" id="trailer2" required  name="price_trailer" placeholder="Precio"  min="0" step="0.01">
    </div>
  </div>
...
switch (Core::$user->language){
 case 'ES': echo "Datos del Vehiculo"; break;
 case 'EN': echo "Vehicle Data"; break;
}
?>:
</div>
    ...
    <select style="background-color: #333;" name="stock_id" required   class="form-control">
    <?php foreach(StockData::getAll() as $stock):?>
     <option value="<?php echo $stock->id;?>" <?php if($stock->id==$user->stock_id){echo 'selected';}?>><?php echo $stock->name;?></option> 
    <?php endforeach;?>
    </select>
    </div>
  </div>
 ...
 <div class="col-md-2 col-12" id="rpayment" style="display: none">
    <label for="inputEmail1" class="col-md-12 col-12 control-label">Precio/Dia</label>
      <input style="background-color: #333;" type="number" value="0" required name="rpayment"  class="form-control" placeholder="<?php 
switch (Core::$user->language){
 case 'ES': echo "Escribir Aqui"; break;
 case 'EN': echo "Write Here"; break;
}
...
?></label>
    <select style="background-color: #333;" name="car_id" required  class="form-control select2">
...
?></label>
    ...
    <select style="background-color: #333;" name="car2_id" class="form-control select2">
    <option value="0">--<?php 
switch (Core::$user->language){
 case 'ES': echo "ELEGIR"; break;
 case 'EN': echo "CHOOSE"; break;
...
?></label>
    <input style="background-color: #333;" id="dias" name="day" value="<?php echo $user->day;?>"  class="form-control">
    </div>
</div>
...
?></label>
    <input style="background-color: #333;" type="number" value="<?php echo $user->price;?>" required name="price2" id="tariff2"  class="form-control" placeholder="<?php 
switch (Core::$user->language){
 case 'ES': echo "Escribir Aqui"; break;
 case 'EN': echo "Write Here"; break;
}
...
?></label>
    <span class="input-group-text autocomplete" style="background-color:orange;"><i class="fa fa-asterisk"></i></span>
     <input style="background-color: #333;" type="number" value="<?php echo $user->price*$user->day;?>" required name="total" id="amount"  class="form-control" placeholder="<?php 
switch (Core::$user->language){
 case 'ES': echo "Escribir Aqui"; break;
 case 'EN': echo "Write Here"; break;
}
...
?></label>
    <span class="input-group-text autocomplete" style="background-color:orange;"><i class="fa fa-asterisk"></i></span>
      <input style="background-color: #333;" type="number" value="0" required name="payment" id="payment" class="form-control" placeholder="<?php 
switch (Core::$user->language){
 case 'ES': echo "Escribir Aqui"; break;
 case 'EN': echo "Write Here"; break;
}
...
?></label>
    <input style="background-color: #333;" text="number" required value="0"  name="plane"  class="form-control"  min="0" step="0.01">
    </div>
  </div>
    ...
    <div class="input-group" >
                      ...
                      <label for="inputEmail1" class="col-md-12 col-12 control-label"><?php echo StockData::getPrincipal()->imp_name; ?></label>
    <div class="icheck-primary d-inline">
                        <input style="background-color: #333;" type="checkbox" name="iva" id="checkbox2">
                        <label for="checkbox2">
                          <?php echo StockData::getPrincipal()->imp_val;?>%
                        </label>
                      </div>
    </div>
  </div>
...
$("#remaining").val( agregarSeparadorMiles(<?php echo $user->price*$user->day;?>));
...
<input style="background-color: #333;" type="hidden" value="<?php echo $_GET["id"];?>" required name="user_id" class="form-control">
...
?></label>
      <input style="background-color: #333;" type="datetime-local"  required name="start_at" id="start_at" class="form-control " >
    </div>
...
?></label>
      <input style="background-color: #333;" value="<?php echo $user->start_at;?>"  type="datetime-local"  required name="start_at" id="start_at" class="form-control " >
    </div>
...
?></label>
      <input style="background-color: #333;" value="<?php echo $user->end_at;?>"  type="datetime-local"  name="end_at" id="end_at"  class="form-control"> 
        </div>
...
?></label>
      ...
      <select style="background-color: #333;" class="form-control" name="type_sure">
      <?php foreach (SureData::getALL() as $sure): ?>
     <option value="<?php echo $sure->id;?>"<?php if($sure->id==$user->sure){ echo "selected"; }?>><?php echo $sure->name;?></option>
      <?php endforeach ?>
      </select>
</div>
<div class="col-md-2 col-12 "> 
...
?></label>
          ...
          <input style="background-color: #333;" value="<?php echo $user->sure;?>" type="text" name="sure" class="form-control" value="0"   placeholder="<?php 
switch (Core::$user->language){
 case 'ES': echo "Escribir Aqui"; break;
 case 'EN': echo "Write Here"; break;
}
...
?></label>
  ...
  <style>
    ...
    <span id="toggleplace_start" class="input-group-text btn-danger"><i class="fa fa-retweet"></i></span>
           <select id="place_start" style="background-color: #333;" class="form-control"  name="place_start">
               <option value="" selected disabled>--- <?php 
switch (Core::$user->language){
 case 'ES': echo "ELEGIR"; break;
 case 'EN': echo "CHOOSE"; break;
...
?> ---</option>
      ...
      <input  name="place_start2" style="background-color: #333;" class="form-control" type="text" id="place_start2" placeholder="Escribe aquí">
    </div>
  </div>
    ...
    <script>
        $(document).ready(function () {
            $("#toggleplace_start").click(function () {
                // Alternar visibilidad entre select y input
                $("#place_start").toggle();
                $("#place_start2").toggle();
...
?></label>
  ...
  <style>
     ...
     <span id="toggleplace_end" class="input-group-text btn-danger"><i class="fa fa-retweet"></i></span>
           <select id="place_end" style="background-color: #333;" class="form-control"  name="place_end">
               <option value="" selected disabled>--- <?php 
switch (Core::$user->language){
 case 'ES': echo "ELEGIR"; break;
 case 'EN': echo "CHOOSE"; break;
...
?> ---</option>
      ...
      <input  name="place_end2" style="background-color: #333;" class="form-control" type="text" id="place_end2" placeholder="Escribe aquí">
    </div>
  </div>
...
<div class="col-md-3 col-12" hidden>
    ...
    <label for="inputEmail1" class="col-md-12 col-12 control-label">Rent A Car</label>
    <span class="input-group-text autocomplete" style="background-color:orange;"><i class="fa fa-street-view"></i></span>
    <select style="background-color: #333;" name="stock_id" id="select2lista"  class="form-control" onchange="showInp()"></select>
    </div>
  </div>
...
?></label>
    <input style="background-color: #333;" type="number" value="<?php echo $user->price;?>"   name="price2" id="tariff2"  class="form-control" placeholder="<?php 
switch (Core::$user->language){
 case 'ES': echo "Escribir Aqui"; break;
 case 'EN': echo "Write Here"; break;
}
?>"  min="0" step="0.01">
    ...
    <span class="input-group-text autocomplete" style="background-color:orange;"><i class="fa fa-list-ol"></i></span>
     <select style="background-color: #333;" name="iva" id="iva"  class="form-control" onchange="showIva()">
         ...
         <option value="<?php echo StockData::getPrincipal()->imp_val;?>">SI</option>
     </select>
    </div>
  </div>
...
?></label>
      ...
      <input style="background-color: #333;" type="number" value="<?php echo $user->payment;?>"  name="payment" id="payment" class="form-control" placeholder="<?php 
switch (Core::$user->language){
 case 'ES': echo "Escribir Aqui"; break;
 case 'EN': echo "Write Here"; break;
}
...
?></label>
     <input style="background-color: #333;" type="number" value="<?php echo $user->plane;?>" name="plane"   class="form-control" min="0" step="0.01">
    </div>
  </div>
...
$("#remaining").val( agregarSeparadorMiles((($('#tariff2').val()*$('#dias').val())*$('#divisa_id').val())-parseFloat($("#payment").val())));
...
<div class="row">
 ...
 <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
         <h1 class="m-0"><i class='fa fa-user-plus'></i> Confirmar Reservacion</h1>
          </div><!-- /.col -->
         <div class="col-sm-6">
  <ol class="breadcrumb float-sm-right">
    <li class="breadcrumb-item active">
...
?></label>
    <select style="background-color: #333;" class="form-control" required>
...
?> </label>
   <select style="background-color: #333;" class="form-control" >
    <option value="">-- <?php 
switch (Core::$user->language){
 case 'ES': echo "ELEGIR"; break;
 case 'EN': echo "CHOOSE"; break;
...
?></label>
      <input style="background-color: #333;" type="datetime-local" value="<?php echo $sell->start_at;?>" readonly class="form-control " >
    </div>
...
?></label>
      <input style="background-color: #333;" type="datetime-local" value="<?php echo $sell->end_at;?>" readonly class="form-control"> 
        </div>
...
?></label>
    <select style="background-color: #333;" name="f_id" required class="form-control">
...
?></label>
          ...
          <input style="background-color: #333;" type="text" readonly class="form-control" value="<?php echo $sell->sure;?>"   placeholder="<?php 
switch (Core::$user->language){
 case 'ES': echo "Escribir Aqui"; break;
 case 'EN': echo "Write Here"; break;
}
...
?></label>
     <input style="background-color: #333;" class="form-control" readonly value="<?php echo $sell->place_start;?>">
    </div>
  </div>
...
?></label>
     <select style="background-color: #333;" class="form-control select2" name="place_end">
         <?php foreach(PlaceData::getAll() as $place):?>
         <option value="<?php echo $place->name;?>"><?php echo $place->name;?></option>
         <?php endforeach;?>
     </select>
...
?>:
    ...
    <select style="background-color: #333;" class="form-control" id="location">
...
<div class="col-md-3 col-12" hidden>
    ...
    <label for="inputEmail1" class="col-md-12 col-12 control-label">Rent A Car</label>
    <span class="input-group-text autocomplete" style="background-color:orange;"><i class="fa fa-street-view"></i></span>
    <select style="background-color: #333;" id="select2lista"  class="form-control"></select>
    </div>
  </div>
...
?> (Solicitado)</label>
    <select style="background-color: #333;"  id="cars2" class="form-control select2">
...
<div class="col-md-2 col-12" id="cars2_plate">
    <label for="inputEmail1" class="col-md-12 col-12 control-label">No. de Placa</label>
      <input style="background-color: #333;" type="text" data-inputmask='"mask": "A 999999"' data-mask name="cars2_plate" autocomplete="off"  class="form-control" placeholder="<?php 
switch (Core::$user->language){
 case 'ES': echo "Escribir Aqui"; break;
 case 'EN': echo "Write Here"; break;
}
...
<div class="row">
 <div class="col-md-3 col-12">
     ...
     <input style="background-color: #333;" type="text" value="CAMILLA" class="form-control" autocomplete="off"  readonly>
       <div class="input-group">
     <span class="input-group-text autocomplete" style="background-color:orange;">UND</span>
     <input style="background-color: #333;" class="form-control" readonly value="<?php echo $sell->unit_extra1;?>"  autocomplete="off" id="unit1"  placeholder="Unidad"  min="0">
       <input style="background-color: #333;" class="form-control" readonly value="<?php echo $sell->price_extra1;?>"   autocomplete="off" id="price1"   placeholder="Precio"  min="0" step="0.01">
    </div>
  </div>

 <div class="col-md-3 col-12">
     
     <input style="background-color: #333;" type="text" value="OXIGENO" class="form-control" autocomplete="off"  readonly>
       <div class="input-group">
     <span class="input-group-text autocomplete" style="background-color:orange;">UND</span>
        <input style="background-color: #333;" class="form-control" readonly value="<?php echo $sell->unit_extra2;?>"  autocomplete="off" id="unit2"   placeholder="Unidad"  min="0" >
       <input style="background-color: #333;" class="form-control" readonly value="<?php echo $sell->price_extra2;?>"  placeholder="Precio"  min="0" step="0.01">
    </div>
  </div>
 ...
 <div class="col-md-3 col-12">
     ...
     <input style="background-color: #333;" type="text" value="DESFIBRILADOR" class="form-control" autocomplete="off" readonly>
       <div class="input-group">
     <span class="input-group-text autocomplete" style="background-color:orange;">UND</span>
      <input style="background-color: #333;" class="form-control" readonly value="<?php echo $sell->unit_extra3;?>"   autocomplete="off" id="unit3"   placeholder="Unidad"  min="0" >
       <input style="background-color: #333;" class="form-control" readonly value="<?php echo $sell->price_extra3;?>"   autocomplete="off" id="price3"    placeholder="Precio"  min="0" step="0.01">
    </div>
  </div>
 
 <div class="col-md-3 col-12">
     
     <input style="background-color: #333;" type="text" value="SILLA DE RUEDA" class="form-control" autocomplete="off"  readonly>
       <div class="input-group">
     <span class="input-group-text autocomplete" style="background-color:orange;">UND</span>
       <input style="background-color: #333;" class="form-control" readonly value="<?php echo $sell->unit_extra4;?>"   class="form-control" autocomplete="off" id="unit4" placeholder="Unidad"  min="0" >
        <input style="background-color: #333;" class="form-control" readonly value="<?php echo $sell->unit_extra4;?>"   autocomplete="off" id="price4"  placeholder="Precio"  min="0" step="0.01">
    </div>
  </div>
  </div>
...
<div class="row">
 <div class="col-md-4 col-12">
     ...
     <input style="background-color: #333;" type="text" value="CARSEAT" class="form-control" autocomplete="off"  readonly>
       <div class="input-group">
     <span class="input-group-text autocomplete" style="background-color:orange;">UND</span>
      <input style="background-color: #333;" class="form-control" readonly value="<?php echo $sell->unit_extra1;?>"   class="form-control" autocomplete="off" id="unit1"   placeholder="Unidad"  min="0">
       <input style="background-color: #333;" class="form-control" readonly value="<?php echo $sell->unit_extra1;?>"   class="form-control"   autocomplete="off" id="price1" placeholder="Precio"  min="0" step="0.01">
    </div>
  </div>

 <div class="col-md-4 col-12">
     
     <input style="background-color: #333;" type="text" value="INTERNET" class="form-control" autocomplete="off"  readonly>
       <div class="input-group">
     <span class="input-group-text autocomplete" style="background-color:orange;">UND</span>
     <input style="background-color: #333;" class="form-control" readonly value="<?php echo $sell->unit_extra2;?>"   autocomplete="off" id="unit2"  placeholder="Unidad"  min="0" >
       <input style="background-color: #333;" class="form-control" readonly value="<?php echo $sell->price_extra2;?>"  autocomplete="off" id="price2" placeholder="Precio"  min="0" step="0.01">
    </div>
  </div>
 ...
 <div class="col-md-4 col-12">
     ...
     <input style="background-color: #333;" type="text" value="TRAILER" class="form-control" autocomplete="off"  readonly>
       <div class="input-group">
     <span class="input-group-text autocomplete" style="background-color:orange;">UND</span>
       <input style="background-color: #333;" class="form-control" readonly value="<?php echo $sell->unit_extra3;?>" class="form-control" autocomplete="off" id="unit3"  placeholder="Unidad"  min="0" >
       <input style="background-color: #333;" class="form-control" readonly value="<?php echo $sell->price_extra3;?>"   autocomplete="off" id="price3"  placeholder="Precio"  min="0" step="0.01">
    </div>
  </div>
...
?></label>
    <input style="background-color: #333;" value="<?php echo $sell->day;?>" readonly  class="form-control">
    </div>
</div>
...
?></label>
    <input style="background-color: #333;" value="<?php echo $sell->price;?>"  class="form-control" readonly>
    </div>
    ...
    <label for="inputEmail1" class="col-md-12 col-12 control-label"><?php echo StockData::getPrincipal()->imp_name; ?> (<?php echo StockData::getPrincipal()->imp_val;?>%)</label>
    <span class="input-group-text autocomplete" style="background-color:orange;"><i class="fa fa-list-ol"></i></span>
     <select style="background-color: #333;" id="iva"  class="form-control" onchange="showIva()">
         <option value="0" <?php if($sell->iva=="0"){ echo "selected";};?>>NO</option>
         <option value="<?php echo StockData::getPrincipal()->imp_val;?>" <?php if($sell->iva== StockData::getPrincipal()->imp_val){ echo "selected";};?>>SI</option>
     </select>
    </div>
  </div>
   ...
   <div class="col-md-3 col-12" id="type_iva">
    ...
    <select style="background-color: #333;" class="form-control select2">
...
?></label>
    <span class="input-group-text autocomplete" style="background-color:orange;"><i class="fa fa-asterisk"></i></span>
     <input style="background-color: #333;" value="<?php echo $sell->total;?>"  class="form-control" readonly>
    </div>
  </div>
  
   <div class="col-md-3 col-12" id="iva_value">
    <label for="inputEmail1" class="col-md-12 col-12 control-label">Valor (<?php echo StockData::getPrincipal()->imp_val;?>%)</label>
  <input style="background-color: #333;" value="<?php echo $sell->value_iva;?>"  class="form-control" readonly>
    </div>   
   ...
   <div class="col-md-3 col-12">
    ...
    <label for="inputEmail1" class="col-md-12 col-12 control-label">Total Extra</label>
    <span class="input-group-text autocomplete" style="background-color:orange;"><i class="fa fa-asterisk"></i></span>
   <input style="background-color: #333;" value="<?php echo $sell->xtotal;?>"  class="form-control" readonly>
    </div>
  </div>
...
?>
   <input style="background-color: #333;" value="<?php echo $tz;?>"  class="form-control" readonly>
    </div>
  </div>
...
?>
   <input style="background-color: #333;" value="<?php echo $tx;?>"  class="form-control" readonly>
    </div>
  </div>
...
?></label>
     <input style="background-color: #333;" value="<?php echo $sell->plane;?>"  class="form-control" readonly>
    </div>
  </div>
  </div>
...
<i class="fa fa-edit"></i> Firma del Cliente:
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <input style="background-color: #333;" type="button" class="button" id="draw-clearBtn" value="Borrar Firma"></input>


         
            <input style="background-color: #333;" type="color" id="color" hidden>
            <input style="background-color: #333;" hidden type="range" id="puntero" min="1" default="1" max="5" width="10%">
    ...
    <div hidden class="row">
      <div class="col-md-12">
        <textarea  id="draw-dataUrl" class="form-control" name="base64" rows="5"></textarea>
      </div>
    </div>
