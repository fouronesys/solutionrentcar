...
<div class="row">
 ...
 <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
           <h1 class="m-0"><i class="fa fa-minus-square"></i>  Area de Taller</h1>
          </div><!-- /.col -->
...
<thead>
 ...
 <?php
      foreach(CarsData::getAllBySQL("where status=4 and stock_id=".StockData::getPrincipal()->id) as $sells):?>
        <tr>
                  <td class="text-right py-0 align-middle">
                      <div class="btn-group btn-group-sm btn-block">
                        <a href="./?view=cogs&opt=vehicle&car_id=<?php echo $sells->id;?>" class="btn btn-success"><i class="fas fa-eye"></i></a>
                      </div>
        </td>
        ...
        <td> <a href="./?action=cars&opt=status&id=<?php echo $sells->id;?>&status=0" class="btn btn-sm btn-block btn-warning"><i class="fa fa-check"></i> LISTO </a></td>
    </tr>
...
<script>
  ...
  $.get("./?action=get&opt=vehicule","",function(data2){
     ...
     $("#maintenance").submit(function(e){
            e.preventDefault();
            $.post("./?action=cogs&opt=add",$("#maintenance").serialize(),function(data){
