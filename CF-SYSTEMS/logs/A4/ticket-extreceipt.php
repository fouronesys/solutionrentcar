...
$paymentInfo = PaymentData::getClientByPayment($sell->id);
$clients = StockData::getById($_GET["person_id"]);
...
foreach($items as $row){
    ...
    $pdf->Cell(55,7,substr($row[3],0,35).'...',1);
