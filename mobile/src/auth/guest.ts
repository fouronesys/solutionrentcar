...
export const GUEST_USERNAME = process.env.EXPO_PUBLIC_GUEST_USERNAME ?? "casarivas.guest";
export const GUEST_PASSWORD = process.env.EXPO_PUBLIC_GUEST_PASSWORD ?? "crguest2026";
