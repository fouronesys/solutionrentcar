<?php
class MData {
	public static $tablename = "maintenance_type";
...
// partiendo de que ya tenemos creado un objecto MData previamente utilizamos el contexto
	...
	public static function getById($id){
		...
		return Model::one($query[0],new MData());
	}
	...
	public static function getAllBySQL($sqlextra){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new MData());
	}
