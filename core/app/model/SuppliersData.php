...
class SuppliersData {
	...
	public function add(){
		$sql = "insert into ".self::$tablename." (name,is_ext)";
		$sql .= "value (\"$this->name\",\"$this->is_ext\")";
		Executor::doit($sql);
	}
...
// partiendo de que ya tenemos creado un objecto SuppliersData previamente utilizamos el contexto
	...
	public static function getById($id){
		...
		return Model::one($query[0],new SuppliersData());
	}
	...
	public static function getAllBySQL($sqlextra){
		...
		$query = Executor::doit($sql);
		return Model::many($query[0],new SuppliersData());
	}
