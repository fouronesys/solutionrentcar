      ...
      <div class="col-md-12">
        <textarea style="background-color:#333;"  id="draw-dataUrl" class="form-control" name="base64" rows="5"></textarea>
                ...
                <div class="col-md-12 col-12 my-2">
                   ...
                   <button type="button" id="draw-submitBtn" class="btn btn-success btn-block btn-sm">
...
document.getElementById('draw-submitBtn').addEventListener('click', function (e) {
  e.preventDefault();

  var canvas = document.getElementById("draw-canvas");
  var ctx = canvas.getContext("2d");

  // Crear una copia en blanco del canvas para comparar
  var emptyCanvas = document.createElement('canvas');
  emptyCanvas.width = canvas.width;
  emptyCanvas.height = canvas.height;
  var emptyData = emptyCanvas.toDataURL();
  var actualData = canvas.toDataURL();

  // ✅ Si el canvas está en blanco (sin trazos), lo tratamos como “no firmó”
  if (actualData === emptyData) {
    document.getElementById("draw-dataUrl").value = "";
    console.log("⚠️ No firmó — canvas vacío.");
  } else {
    document.getElementById("draw-dataUrl").value = actualData;
    console.log("✅ Firmó correctamente.");
  }

  // Enviar el formulario de todas formas (con o sin firma)
...
switch (Core::$user->language){
 case 'ES': echo "Editar Contrato"; break;
 case 'EN': echo "Edit contract"; break;
}
?></h1>
          </div><!-- /.col -->
        <div class="col-sm-6">
...
<form class="form-horizontal" action="./?action=contract&opt=upd" method="post" id="delivery" role="form" enctype="multipart/form-data">
...
?></label>
          ...
          <input style="background-color: #333;" value="<?php echo $user->sure;?>" type="text" name="sure" class="form-control"   placeholder="<?php 
switch (Core::$user->language){
 case 'ES': echo "Escribir Aqui"; break;
 case 'EN': echo "Write Here"; break;
}
?>" autocomplete="off" >
 ...
 <div hidden class="col-md-4 col-12">
    ...
    <label for="inputEmail1" class="col-md-12 col-12 control-label">Deposito</label>
     <span class="input-group-text autocomplete" style="background-color:orange;"><i class="fa fa-asterisk"></i></span>
      <input style="background-color: #333;" type="text" name="deposit" value="<?php echo $user->deposit;?>" class="form-control" placeholder="<?php 
switch (Core::$user->language){
 case 'ES': echo "Escribir Aqui"; break;
 case 'EN': echo "Write Here"; break;
}
...
?> ---</option>
      ...
      <input  name="place_start2" style="background-color: #333;" class="form-control" type="text" id="place_start2" value="<?php echo $user->place_start;?>" placeholder="Escribe aquí">
    </div>
  </div>
...
?> ---</option>
      ...
      <input  name="place_end2" style="background-color: #333;" class="form-control" type="text" id="place_end2" value="<?php echo $user->place_end;?>" placeholder="Escribe aquí">
    </div>
  </div>
...
?></label>
  ...
  <div class="col-md-2 col-12" id="rpayment" style="display: none">
    <label for="inputEmail1" class="col-md-12 col-12 control-label">Precio/Dia</label>
      <input style="background-color: #333;" type="number" value="<?php echo $user->rpayment;?>" name="rpayment"  class="form-control" placeholder="<?php 
switch (Core::$user->language){
 case 'ES': echo "Escribir Aqui"; break;
 case 'EN': echo "Write Here"; break;
}
...
?></label>
     <input style="background-color: #333;" type="number" value="<?php echo $user->plane;?>" name="plane" id="plane" class="form-control" min="0" step="0.01">
    </div>
  </div>
...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
           <h1 class="m-0" style="color: white;"><i class='fa fa-random'></i> 
             <?php echo ($language_user=='ES') ? "Listado de Contratos" : "List of Contracts"; ?>
           </h1>
          </div>
...
$con = $base->connect();
if(isset($_SESSION["user_id"])):
$sql = "SELECT SQL_BIG_RESULT * FROM booking WHERE type_id=1 AND status=1 AND stock_id=".$stock_user->id;
elseif(isset($_SESSION["client_id"])):
$sql = "SELECT SQL_BIG_RESULT * FROM booking WHERE type_id=1 AND status=1 AND person_id=".$clistock->id;
endif;
...
<?php if(isset($_SESSION["user_id"])):?>  
    <th><?php echo ($language_user=='ES') ? "Accion" : "Action"; ?></th>
<?php endif;?>    
    <th><?php echo ($language_user=='ES') ? "Vehiculo" : "Vehicle"; ?></th>

<?php if(isset($_SESSION["user_id"])):?>
    <th><?php echo ($language_user=='ES') ? "Cliente" : "Customer"; ?></th>
<?php endif;?>
    <th><?php echo ($language_user=='ES') ? "Precio/Dia" : "Price/Day"; ?></th>
    <th><?php echo ($language_user=='ES') ? "Dia" : "Day"; ?></th>
    <th>SubTotal</th>
    <th><?php echo $stock_user->imp_name." (".$stock_user->imp_val."%)"; ?></th>
    <th>Total</th>
    <th><?php echo ($language_user=='ES') ? "Abonado" : "Subscriber"; ?></th>
    <th><?php echo ($language_user=='ES') ? "Restante" : "Remaining"; ?></th>
    <th>Extra</th>
    <th><?php echo ($language_user=='ES') ? "Otros" : "Other"; ?></th>
    <th><?php echo ($language_user=='ES') ? "Tarjeta" : "Card"; ?> (<?php echo $stock_user->card."%"; ?>)</th>

<?php if(isset($_SESSION["user_id"])):?>
    <th>RentCar</th>
<?php endif;?>
    <th><?php echo ($language_user=='ES') ? "Entrega" : "Delivery"; ?></th>
    <th><?php echo ($language_user=='ES') ? "Recibir" : "Receive"; ?></th>

<?php if(isset($_SESSION["user_id"])):?>
    <th><?php echo ($language_user=='ES') ? "Creado Por" : "Created By"; ?></th>
<?php endif;?>
  </tr>
</thead>
...
<?php if(isset($_SESSION["user_id"])):?>
    <td width="15%">
      ...
      <a href="./?view=contract&opt=received&cars=<?php echo $cars1->id;?>&id=<?php echo $r['id'];?>" 
         class="btn btn-warning  btn-sm"><i class="fas fa-car"></i></a>
         
          <a href="./?view=contract&opt=edit&id=<?php echo $r['id'];?>" class="btn btn-success"><i class="fas fa-edit"></i></a> 
          </div>
    </td>
<?php endif;?>
    <td>
...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
           <h1 class="m-0" style="color: white;"><i class='fa fa-edit'></i> <?php echo ($language_user=='ES') ? "Listado de Contratos" : "List of Contracts"; ?></h1>
          </div>
...
$wherePerson = "";
if($person_id > 0){
  $wherePerson = " AND person_id=".$person_id;
}

$sql = "SELECT SQL_BIG_RESULT * 
        FROM booking 
        WHERE status=3 
        AND stock_id=".(int)$stock_user->id."
        $wherePerson
        AND start_at BETWEEN '$from 00:00:00' AND '$to 23:59:59'
        ORDER BY id DESC";
$query = $con->query($sql);
...
<div class="card" style="background-color:#222; color:white;">
  <div class="card-body">
    ...
    <form method="GET" class="mb-3">
      <input type="hidden" name="view" value="contract">
      <input type="hidden" name="opt" value="finished">

      <div class="row">
        <div class="col-md-3 mb-2">
          <label style="color:white;"><?php echo ($language_user=='ES') ? "Desde" : "From"; ?></label>
          <input type="date" name="from" class="form-control" value="<?php echo htmlspecialchars($from); ?>">
        </div>

        <div class="col-md-3 mb-2">
          <label style="color:white;"><?php echo ($language_user=='ES') ? "Hasta" : "To"; ?></label>
          <input type="date" name="to" class="form-control" value="<?php echo htmlspecialchars($to); ?>">
        </div>

        <div class="col-md-4 mb-2">
          <label style="color:white;"><?php echo ($language_user=='ES') ? "Cliente" : "Customer"; ?></label>
          <select name="person_id" class="form-control">
            <option value="0"><?php echo ($language_user=='ES') ? "Todos los clientes" : "All customers"; ?></option>
            <?php
            $persons = PersonData::getAll();
            if(is_array($persons)){
              foreach($persons as $p){
                if(isset($p->stock_id) && $p->stock_id != $stock_user->id) continue;
                $selected = ($person_id == $p->id) ? "selected" : "";
        ...
        <div class="col-md-2 mb-2 d-flex align-items-end">
          <button type="submit" class="btn btn-success btn-block">
            <i class="fa fa-search"></i> <?php echo ($language_user=='ES') ? "Filtrar" : "Filter"; ?>
          </button>
        </div>
      </div>
    </form>
    ...
    <div class="table-responsive">
      <table class="table table-bordered" id="example2">
        <thead style="background-color: #333;">
          <tr>
            <th><?php echo ($language_user=='ES') ? "Acción" : "Action"; ?></th>
            <th><?php echo ($language_user=='ES') ? "Vehículo" : "Vehicle"; ?></th>
            <?php if(isset($_SESSION["user_id"])):?>
            <th><?php echo ($language_user=='ES') ? "Cliente" : "Customer"; ?></th>
            <?php endif;?>
            <th><?php echo ($language_user=='ES') ? "Precio/Día" : "Price/Day"; ?></th>
            <th><?php echo ($language_user=='ES') ? "Día" : "Day"; ?></th>
            <th>SubTotal</th>
        ...
        <tr>
          ...
          <td class="text-right py-0 align-middle">
            <?php  
            if(isset($_SESSION["user_id"])) {
              $sl = "SELECT SQL_BIG_RESULT * FROM permits_user WHERE user_id=".(int)$_SESSION["user_id"];
              $qry = $con->query($sl); 
              if($qry){
                while($x = $qry->fetch_array()){
                  if ($x['permits_id']==4): ?>
                    <a href="./?action=contract&opt=del&id=<?php echo $r['id'];?>&cars=<?php echo $r['car_id'];?>"
...
<div class="card" style="background-color:#222; color:white;">
  <div class="card-body">
    ...
    <h2><?php echo ($language_user=='ES') ? "No hay Contratos" : "No Contracts"; ?></h2>
    <p><?php echo ($language_user=='ES') ? "No se ha realizado ninguna operación en ese rango de fecha o cliente." : "No operation has been performed in that date range or customer."; ?></p>
  </div>
</div>
