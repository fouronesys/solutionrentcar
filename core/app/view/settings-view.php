...
<div class="col-md-4 col-12">
    <label for="inputEmail1" class="col-md-12 col-12 control-label">No. Mat</label>
      <div class="input-group">
  <input style="background-color:#333;" type="text" name="no_notario"  class="form-control" placeholder="No Mat" value="<?php echo $stock->no_notario; ?>">
    </div>
  </div>
...
<div class="col-md-6 col-12">
    <label for="inputEmail1" class="col-md-12 col-12 control-label">Testigo #1</label>
      <div class="input-group">
<span class="input-group-text"  style="background-color:orange;"><i class="fa fa-user"></i></span>
  <input style="background-color:#333;" type="text" name="witness1"  class="form-control" placeholder="Testigo #1" value="<?php echo $stock->witness1; ?>">
    </div>
  </div>
...
<div class="col-md-6 col-12">
    <label for="inputEmail1" class="col-md-12 col-12 control-label">Cedula</label>
      <div class="input-group">
  <input style="background-color:#333;" type="text" name="witness1"  class="form-control" placeholder="Cedula" value="<?php echo $stock->no_witness1; ?>">
    </div>
  </div>
  
  <div class="col-md-6 col-12">
    <label for="inputEmail1" class="col-md-12 col-12 control-label">Testigo #2</label>
      <div class="input-group">
<span class="input-group-text"  style="background-color:orange;"><i class="fa fa-user"></i></span>
  <input style="background-color:#333;" type="text" name="witness2"  class="form-control" placeholder="Testigo #2" value="<?php echo $stock->witness2; ?>">
    </div>
  </div>
...
<div class="col-md-6 col-12">
    <label for="inputEmail1" class="col-md-12 col-12 control-label">Cedula</label>
      <div class="input-group">
  <input style="background-color:#333;" type="text" name="no_witness2"  class="form-control" placeholder="Cedula" value="<?php echo $stock->no_witness2; ?>">
    </div>
  </div>
