...
<div class="row">
 ...
 <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
           <h1 class="m-0"><i class="fa fa-dollar-sign"></i>  Listado de Vendidos</h1>
          </div><!-- /.col -->
...
<thead>
 ...
 <?php
      foreach(CarsData::getAllBySQL("where status=5 and stock_id=".StockData::getPrincipal()->id) as $sells):?>
        <tr>
